...
const RUNTIME_JS = [
  ...
  "",
  "  function spotlightEl(shape, color) {",
  "    var el;",
  "    if (shape.kind === 'rect') {",
  "      el = s('rect', { x: shape.x, y: shape.y, width: shape.w, height: shape.h, rx: interaction.spotlightCornerRadius, ry: interaction.spotlightCornerRadius });",
  "    } else {",
  ...
  "    var el = spotlightEl(effectiveSpotlight(hs), hs.color);",
  "    spotlights[hs.id] = el;",
  "    svg.appendChild(el);",
  "  });",
  "",
  ...
  "    groupConnectorPath.classList.remove('drawn');",
  "    if (conn.toShape) {",
  "      arrivalSpotlight = spotlightEl(conn.toShape, hs.color);",
  ...
  "      var showPulse = interaction.pulseEnabled && !selectedId && hs.id !== hoverId;",
